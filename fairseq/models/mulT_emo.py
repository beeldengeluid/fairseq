...
class RobertaEMOModel(FairseqLanguageModel):
    ...
    def __init__(self, args, encoder):
        ...
        list_of_models = list_of_models =['/content/drive/MyDrive/sseft/MM-SHAP-main/SSEFT/pre-trained_models/wav2vec_large.pt']
        ...
        list_of_models =  ['/content/drive/MyDrive/sseft/MM-SHAP-main/SSEFT/pre-trained_models/affectnet_4views.pth']
